...
class AdaptiveCenterCropSquare(object):
    """
    自适应中心裁剪：将任意尺寸图像裁剪为最大的正方形（从中心裁剪）
    """
    def __call__(self, img):
        ...
        if isinstance(img, PIL.Image.Image):
            ...
            c, h, w = img.shape
        square_size = min(w, h)
        return transforms.functional.center_crop(img, square_size)
